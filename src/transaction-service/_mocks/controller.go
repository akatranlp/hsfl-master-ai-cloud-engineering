...
//
//	mockgen -source=transactions/controller.go -package=mocks -destination=_mocks/controller.go
//
...
func (m *MockController) CheckChapterBought(arg0 http.ResponseWriter, arg1 *http.Request) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CheckChapterBought", arg0, arg1)
}

// CheckChapterBought indicates an expected call of CheckChapterBought.
func (mr *MockControllerMockRecorder) CheckChapterBought(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckChapterBought", reflect.TypeOf((*MockController)(nil).CheckChapterBought), arg0, arg1)
}
